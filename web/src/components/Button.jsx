    ...
    case 'anchor':
      return (
        <AnchorLink
          to={anchor}
          title={title}
          className="inline-flex items-center text-lg font-medium text-gray-50 hover:text-white border border-gray-50 hover:border-gray-50 rounded-md shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 hover:-translate-y-0.5 translate transform transition-all"
          secondaryBtn={secondaryBtn}
          bgColor={secondaryBtn ? 'transparent' : accent.default.color}
          bgColorHover={secondaryBtn ? accent.default.color : accent.dark.color}
        >
