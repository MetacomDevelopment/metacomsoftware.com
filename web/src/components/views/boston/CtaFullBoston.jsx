...
const content = {
  headline: 'Scale Your Boston Company With Top Talent',
  subHeadline: 'Give us a call at',
};

const CtaFullBoston = () => {
  const data = useStaticQuery(graphql`
    query CtaFullBostonQ {
      imgCtaFullBg: file(
        relativePath: {
          eq: "assets/images/boston-ma/boston-ma-engineering-roles-recruiter-agency-all-star-connections.jpg"
        }
      ) {
        childImageSharp {
