...
const CtaHalfSanDiego = () => {
  const data = useStaticQuery(graphql`
    query CtaHalfSanDiegoQ {
      ...
      imgCta: file(
        relativePath: {
          eq: "assets/images/san-diego-ca/san-diego-ca-staffing-request-talent-send-resume-engineering-job-recruiter-agency-all-star-connections.jpg"
        }
      ) {
        childImageSharp {
      ...
      <div className="relative max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        ...
        >
          <h3 className="text-base font-semibold uppercase tracking-wider text-gray-300">
            Professional San Diego Recruitment
          </h3>
          ...
          <div className="space-y-6 mt-6">
            <p className="text-lg text-gray-300">
              All-Star Connections prides itself on being San Diego's leader
              when it comes to helping companies like yours find talented people
              who are great culture fits, specifically tailored to your needs.
            </p>
            <p className="text-lg text-gray-300">
...
export default CtaHalfSanDiego;
