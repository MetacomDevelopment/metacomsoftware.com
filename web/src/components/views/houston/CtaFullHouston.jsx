...
const content = {
  headline: 'Scale Your Houston Company With Top Talent',
  subHeadline: 'Give us a call at',
};

const CtaFullHouston = () => {
  const data = useStaticQuery(graphql`
    query CtaFullHoustonQ {
      imgCtaFullBg: file(
        relativePath: {
          eq: "assets/images/houston-tx/houston-tx-engineering-roles-recruiter-agency-all-star-connections.jpg"
        }
      ) {
        childImageSharp {
