...
const CivilPage = ({ location }) => {
  ...
  const hero = {
    header: 'Civil & Structural Engineering Staffing',
    subheader:
      ...
      <PageSidebar>
        <div className="space-y-12">
          <div className="space-y-6">
            <h2>Civil & Structural Engineering Recruiting Agency</h2>
            <p>
              Our team of Civil & Structural Engineering recruiters has the
              talent, skills, and experience to find high-quality candidates
              with a passion for developing cutting-edge devices.
            </p>
            <p>
            ...
            <p>
              ...
              the Civil & Structural Engineering industry, particularly in
          ...
          <div className="space-y-6">
            <h2>Civil & Structural Engineering Recruiting Agency</h2>
            <p>
              All-Star Connections specializes in staffing solutions for Civil &
              Structural Engineering companies in search of life science
              professionals.
            </p>
            <p>
          ...
          <div className="space-y-6">
            <h2>
              Finding the Right Civil & Structural Engineering Talent is Hard
            </h2>
            <p>
          ...
          <div className="space-y-6">
            ...
            <p>
              By allowing our Civil & Structural Engineering and Information
              Technology (IT) recruiting agents to take on the arduous task of
              finding the best candidates, you'll save yourself time and money.
            </p>
            <p>
          ...
          <div className="space-y-6">
            <h2>Hight Rated Among Civil & Structural Engineering Companies</h2>
            <p>
            ...
            <div className="py-10 space-y-16">
              <div>
                <Testimonial
                  ...
                  header="5-Star Civil & Structural Engineering Recruiting Review"
          ...
          <div className="space-y-6">
            <h2>
              Build Your World-Class Civil & Structural Engineering Team Today
            </h2>
            <p>
          ...
          <div className="space-y-6">
            ...
            <ol className="space-y-6">
              ...
              <li>
                <h3 className="text-lg normal-case">
                  How much experience does your Civil & Structural Engineering
                  recruitment agency have in this area?
                </h3>
              </li>
              <li>
                <h3 className="text-lg normal-case">
