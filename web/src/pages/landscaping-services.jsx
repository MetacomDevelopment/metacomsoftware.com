...
const LandscapingServicesPage = () => {
  const data = useStaticQuery(graphql`
    query LandscapingServicesPageQ {
      site {
        siteMetadata {
          company
          siteUrl
  ...
  return (
    <Layout>
      ...
      <HeroPage
        imgHeroBg={imgHeroBg}
        headerText="Our Landscaping Services"
        subheaderText="Check our landscaping services for residential homes & commercial businesses"
      />
      <motion.div
        ref={ref}
