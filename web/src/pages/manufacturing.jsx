...
const ManufacturingPage = ({ location }) => {
  const data = useStaticQuery(graphql`
    query ManufacturingPageQ {
      imgHeroBg: file(
        relativePath: {
  ...
  const hero = {
    header: 'Manufacturing Staffing',
    subheader:
      'Providing skilled candidates to Manufacturing companies when you need it',
      ...
      <PageSidebar>
        <div className="space-y-12">
          <div className="space-y-6">
            <h2>Manufacturing Recruiting Agency</h2>
            <p>
              Our team of Manufacturing recruiters has the talent, skills, and
            ...
            <p>
              ...
              the Manufacturing industry, particularly in healthcare fields such
              as:
            </p>
          ...
          <div className="space-y-6">
            <h2>Finding the Right Manufacturing Talent is Hard</h2>
            <p>
          ...
          <div className="space-y-6">
            ...
            <p>
              By allowing our Manufacturing and Information Technology (IT)
              recruiting agents to take on the arduous task of finding the best
              candidates, you'll save yourself time and money.
            </p>
            <p>
          ...
          <div className="space-y-6">
            <h2>Hight Rated Among Manufacturing Companies</h2>
            <p>
            ...
            <div className="py-10 space-y-16">
              <div>
                <Testimonial
                  ...
                  header="5-Star Manufacturing Recruiting Review"
          ...
          <div className="space-y-6">
            <h2>Build Your World-Class Manufacturing Team Today</h2>
            <p>
          ...
          <div className="space-y-6">
            ...
            <ol className="space-y-6">
              ...
              <li>
                <h3 className="text-lg normal-case">
                  How much experience does your Manufacturing recruitment agency
                  have in this area?
                </h3>
              </li>
              <li>
