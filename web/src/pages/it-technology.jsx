...
const InfoTechPage = ({ location }) => {
  ...
  const hero = {
    header: 'Information Technology (IT) Staffing',
    subheader:
      'Providing skilled candidates to Information Technology (IT) companies when you need it',
      ...
      <PageSidebar>
        <div className="space-y-12">
          <div className="space-y-6">
            <h2>Information Technology (IT) Recruiting Agency</h2>
            <p>
              Our team of Information Technology (IT) recruiters has the talent,
              skills, and experience to find high-quality candidates with a
              passion for developing cutting-edge devices.
            </p>
            <p>
            ...
            <p>
              ...
              the Information Technology (IT) industry, particularly in
          ...
          <div className="space-y-6">
            ...
            <p>
              ...
              Information Technology (IT) companies in search of life science
              professionals.
            </p>
            <p>
          ...
          <div className="space-y-6">
            <h2>
              Finding the Right Information Technology (IT) Talent is Hard
            </h2>
            <p>
          ...
          <div className="space-y-6">
            ...
            <p>
              By allowing our Information Technology (IT) and Information
          ...
          <div className="space-y-6">
            <h2>Hight Rated Among Information Technology (IT) Companies</h2>
            <p>
            ...
            <div className="py-10 space-y-16">
              <div>
                <Testimonial
                  ...
                  header="5-Star Information Technology (IT) Recruiting Review"
          ...
          <div className="space-y-6">
            <h2>
              Build Your World-Class Information Technology (IT) Team Today
            </h2>
            <p>
          ...
          <div className="space-y-6">
            ...
            <ol className="space-y-6">
              ...
              <li>
                <h3 className="text-lg normal-case">
                  How much experience does your Information Technology (IT)
