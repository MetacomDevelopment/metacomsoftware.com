...
var css_248z = "._3mSuFl-boQRvDDOjvw2d74 {\n  position: absolute;\n  z-index: 1;\n  top: 0;\n  left: 0;\n  width: 100%;\n  height: 100%; }\n  ._3mSuFl-boQRvDDOjvw2d74::before {\n    content: '';\n    position: absolute;\n    left: 0;\n    top: 0;\n    width: 100%;\n    height: 100%;\n    opacity: .6;\n    background-color: var(--card-bg-color); }\n";
var styles = {"overlay":"_3mSuFl-boQRvDDOjvw2d74"};
...
var SEOInputReadabilityTab = function SEOInputReadabilityTab(_ref) {
  ...
  var longSentencePercentage = React__default['default'].useMemo(function () {
    if (insights != null && insights.sentences) {
  ...
  var transitionWordsSentencePercentage = React__default['default'].useMemo(function () {
    if (insights != null && insights.transitionWords) return Math.round(insights.transitionWords.transitionWordSentences / insights.transitionWords.totalSentences * 100);
    return 0;
  }, [insights]);
  return /*#__PURE__*/React__default['default'].createElement(ui.TabPanel, {
    hidden: hidden,
